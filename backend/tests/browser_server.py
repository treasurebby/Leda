...
os.environ.update({
    "APP_ENV": "test", "DATABASE_URL": "sqlite+aiosqlite:///:memory:",
    "SECRET_KEY": "browser-test-only-secret-with-at-least-32-characters",
    "PUBLIC_APP_URL": "http://127.0.0.1:5174", "RESEND_API_KEY": "", "PAYSTACK_SECRET_KEY": "",
    "ANTHROPIC_API_KEY": "", "OPENAI_API_KEY": "", "S3_BUCKET": "", "WHATSAPP_ACCESS_TOKEN": "",
})
